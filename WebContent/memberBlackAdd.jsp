		...
		<hr />
			<form action="memberBlackAdd" method="post">
				<table class="memberList_main">
					...
					<tr>
						<th>관리자 ID</th>
						<td><input type="text" id="managerId" name="managerId" />${dto.managerid}</td>
					</tr>
					<tr>
						<th>해당 아이디</th>
						<td><input type="text" id="userid" name="userid" />${dto.id}</td>
					</tr>
					<tr>
						<th>블랙리스트 등록사유</th>
			...
			<div style="text-align: center; margin-top: 20px;">
				...
				<input type="button" onclick="location.href='./memberBlackList'" value="취소" />
			</div>
	</div>
</body>
<script>
